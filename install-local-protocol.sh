...
composer require sovamc/bedrock-protocol:*@dev sovamc/bedrock-data:*@dev pocketmine/bedrock-block-upgrade-schema:*@dev pocketmine/bedrock-item-upgrade-schema:*@dev
